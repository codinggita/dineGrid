  ...
  return (
    <section className="py-16 md:py-24 bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="rounded-[1.5rem] md:rounded-[2.5rem] overflow-hidden relative min-h-[360px] md:min-h-[500px] flex items-center shadow-2xl">
          ...
          {/* Content */}
          <div className="relative z-10 max-w-2xl p-6 md:p-10 lg:p-16 text-white">
            ...
            <p className="text-base md:text-lg font-[var(--font-body)] text-white/80 mb-6 md:mb-10 leading-relaxed">
