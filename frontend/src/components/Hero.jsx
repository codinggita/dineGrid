...
const Hero = () => {
  ...
  return (
    <div className="relative bg-[var(--color-neutral)] text-white overflow-hidden min-h-[540px] md:min-h-[680px] flex items-center justify-center">
      {/* Background Image */}
      <div
      ...
      <div className="absolute top-0 right-0 w-48 h-48 md:w-96 md:h-96 bg-[var(--color-primary)]/20 rounded-full blur-3xl z-10 pointer-events-none" />
      {/* Subtle bottom glow */}
      <div className="absolute bottom-0 left-1/4 w-48 h-24 md:w-80 md:h-40 bg-[var(--color-secondary)]/10 rounded-full blur-3xl z-10 pointer-events-none" />

      <div className="relative z-20 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-16 pb-20 md:pt-24 md:pb-28">

        {/* Top Badge */}
        <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md border border-white/15 rounded-full px-4 py-1.5 sm:px-5 sm:py-2 mb-6 md:mb-8 flex-wrap justify-center">
          <div className="w-2 h-2 rounded-full bg-[var(--color-primary)] animate-pulse" />
          <span className="text-xs sm:text-sm font-medium text-white/90">47 restaurants live</span>
          <span className="text-white/30 mx-1 hidden sm:inline">|</span>
          <span className="text-xs sm:text-sm font-medium text-white/90">1,200+ diners right now</span>
        </div>
        ...
        {/* Subheadline */}
        <p className="text-base md:text-lg lg:text-xl text-white/75 max-w-2xl mx-auto mb-8 md:mb-10 leading-relaxed px-2">
        ...
        {/* CTA Buttons */}
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center mb-10 md:mb-14">
          <button
