    ...
    <section className="py-16 md:py-24 bg-[var(--color-neutral-light)] text-[var(--color-neutral)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-[var(--font-headline)] mb-4 tracking-tight">A Smarter Way to Dine</h2>
          ...
          <div className="bg-white rounded-3xl overflow-hidden shadow-xl shadow-gray-200/50 hover:shadow-2xl transition-shadow duration-300 border border-gray-100 flex flex-col">
            ...
            <div className="p-6 md:p-10 flex-1 flex flex-col">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-2xl md:text-3xl font-[var(--font-headline)]">For the Hungry Diner</h3>
              </div>
              <ul className="space-y-4 mb-8 flex-1">
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-[var(--color-primary)] shrink-0 mt-0.5" />
                  <span className="font-[var(--font-body)] text-gray-700 text-base md:text-lg">Skip the line and secure your spot from anywhere.</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-[var(--color-primary)] shrink-0 mt-0.5" />
                  <span className="font-[var(--font-body)] text-gray-700 text-base md:text-lg">Live updates and queue tracking right on your phone.</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-[var(--color-primary)] shrink-0 mt-0.5" />
                  <span className="font-[var(--font-body)] text-gray-700 text-base md:text-lg">Earn exclusive rewards every time you dine out.</span>
                </li>
              </ul>
          ...
          <div className="bg-white rounded-3xl overflow-hidden shadow-xl shadow-gray-200/50 hover:shadow-2xl transition-shadow duration-300 border border-gray-100 flex flex-col">
            ...
            <div className="p-6 md:p-10 flex-1 flex flex-col">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-2xl md:text-3xl font-[var(--font-headline)]">For the Restaurateur</h3>
              </div>
              <ul className="space-y-4 mb-8 flex-1">
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-[var(--color-secondary)] shrink-0 mt-0.5" />
                  <span className="font-[var(--font-body)] text-gray-700 text-base md:text-lg">Optimize table turnover during peak rush hours.</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-[var(--color-secondary)] shrink-0 mt-0.5" />
                  <span className="font-[var(--font-body)] text-gray-700 text-base md:text-lg">Manage reservations and walk-ins from one dashboard.</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-[var(--color-secondary)] shrink-0 mt-0.5" />
                  <span className="font-[var(--font-body)] text-gray-700 text-base md:text-lg">Understand guest preferences with rich analytics.</span>
                </li>
              </ul>
