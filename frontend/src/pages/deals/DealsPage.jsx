...
const DealsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-neutral-light)]">
      ...
      <section className="relative h-[400px] sm:h-[480px] md:h-[550px] flex items-center overflow-hidden">
        <div 
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b md:bg-gradient-to-r from-black via-black/70 to-transparent" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black text-white mb-4 leading-tight">
              The Midnight <br />
              <span className="text-[var(--color-primary)]">Rescue.</span>
            </h1>
            
            <p className="text-base md:text-xl text-white/70 mb-8 md:mb-10 max-w-lg leading-relaxed">
              Exquisite food shouldn't go to waste. Join the movement to rescue premium surplus meals at 60-80% off.
            </p>

            <div className="flex flex-wrap items-center gap-6">
              <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-3 md:p-4 min-w-[160px] sm:min-w-[200px]">
                <p className="text-[10px] font-bold text-white/50 uppercase tracking-widest mb-1">Time Remaining</p>
                <p className="text-2xl md:text-3xl font-mono font-black text-[var(--color-primary)]">{timeLeft}</p>
              </div>
              
              <button className="flex items-center gap-3 bg-[var(--color-primary)] hover:bg-[var(--color-primary-dark)] text-white px-6 py-4 md:px-8 md:py-5 rounded-2xl font-black text-base md:text-lg transition-all shadow-2xl shadow-[var(--color-primary)]/40 group">
                Browse Rescues
      ...
      <section className="py-16 md:py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-12">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-[var(--color-neutral)] mb-2">Available Tonight</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div key={deal.id} className="group bg-white rounded-[2.5rem] border border-gray-100 overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500">
              ...
              <div className="p-5 md:p-8">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <h3 className="text-xl md:text-2xl font-black text-[var(--color-neutral)] leading-tight mb-1">{deal.name}</h3>
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-2xl md:text-3xl font-black text-[var(--color-primary)]">{deal.dealPrice}</p>
                  </div>
                </div>
          ...
          {/* Get Notified Card */}
          <div className="bg-[var(--color-primary)]/5 border border-[var(--color-primary)]/10 rounded-[2rem] md:rounded-[2.5rem] p-8 md:p-10 flex flex-col items-center text-center justify-center relative overflow-hidden">
      ...
      {/* ── Rescue. Save. Enjoy. ── */}
      <section className="bg-[var(--color-neutral)] py-16 md:py-24 text-white">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-black mb-4">Rescue. Save. Enjoy.</h2>
          <p className="text-gray-400 text-base md:text-lg mb-12 md:mb-20 max-w-2xl mx-auto">Midnight deals are the ultimate win-win. High-end restaurants clear their kitchens, and you get top-tier food for snack prices.</p>
      ...
      <section className="py-16 md:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20 items-center">
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -right-4 md:-bottom-10 md:-right-10 bg-[var(--color-primary)] text-white p-6 md:p-12 rounded-[1.5rem] md:rounded-[2.5rem] shadow-2xl max-w-[220px] md:max-w-[280px]">
              <p className="text-4xl md:text-6xl font-black mb-2">30%</p>
          ...
          <div>
            <h2 className="text-3xl md:text-4xl lg:text-5xl md:lg:text-6xl font-black text-[var(--color-neutral)] mb-6 md:mb-8 leading-tight">Why do we rescue?</h2>
            <p className="text-base md:text-lg text-gray-400 mb-8 md:mb-12 leading-relaxed">Every meal rescued is one less plate in the landfill. Food waste is a major contributor to global emissions—but it's also a missed opportunity for a great experience.</p>
            ...
            <button className="bg-[var(--color-primary)] hover:bg-[var(--color-primary-dark)] text-white px-6 py-3 md:px-8 md:py-4 rounded-2xl font-black text-sm md:text-base transition-all shadow-xl shadow-[var(--color-primary)]/20">
              Start Your Rescue
            </button>
          </div>
        </div>
